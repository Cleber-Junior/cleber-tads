...
import br.edu.ifsul.cstsi.tads_cleber.autentication.AutenticacaoRepository;
...
public class SecurityFilter extends OncePerRequestFilter {
    ...
    protected void doFilterInternal(HttpServletRequest request, HttpServletResponse response, FilterChain filterChain) throws ServletException, IOException {
        ...
        if (tokenJWT != null) { //se a rota tem o token (no caso, qualquer rota, exceto /login)
            ...
            logger.info("Extracted subject from token: {}", subject);
            ...
            if(usuario != null){
                ...
                logger.warn("No user found with email: {}", subject);
